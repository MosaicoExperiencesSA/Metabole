...
export const VOCI_INIZIALI: Voce[] = [
...

  {
    ...
    titolo: '⚠️ Spegnere una pagina nei Permessi non chiude la porta se il ruolo ha un «hub» che la concede',
    dettaglio:
      'Trovato il 2/9 dalla revisione avversariale sull\'ereditarietà dei permessi. Non è un difetto '
      + 'del codice — è il progetto di `PAGE_GRANTS`, scritto per far sì che «bastino poche voci di '
      + 'menu per gestire tutto» — ma **non è scritto da nessuna parte nella pagina Permessi**, e '
      + 'chi la usa non può indovinarlo.\n\n'
      + '⛔ **Il caso.** Simone spegne `recipes` alla nutrizionista dalla pagina Permessi. La '
      + 'nutrizionista continua a chiamare le API delle ricette, perché ha «Gestione dieta» '
      + '(`diet_workspace`) e quell\'hub concede `diets_catalog` **+ `recipes`**. Dalla schermata '
      + 'sembra spento, e non lo è.\n\n'
      + '⚠️ **Non si chiude togliendo `PAGE_GRANTS`**: quello serve, e toglierlo vorrebbe dire che '
      + 'per lavorare a una dieta bisogna accendere sei pagine.\n\n'
      + '**Le due strade, e la seconda è più onesta:**\n'
      + '· la pagina Permessi **dice** cosa concede una riga («Gestione dieta apre anche: Catalogo '
      + 'diete, Ricette»), e avverte quando si spegne una chiave che un altro permesso acceso '
      + 'concede lo stesso;\n'
      + '· oppure spegnere una chiave la spegne **davvero**, cioè una negazione esplicita batte '
      + 'l\'hub. ⛔ Ma questo cambia il significato della matrice per tutti, e va deciso da Simone: '
      + 'oggi «spento» vuol dire «non te lo do io», non «non ce l\'hai».\n\n'
      + '⚠️ **Da misurare prima**: quante righe in banca dati sono spente su una chiave che un hub '
      + 'acceso concede lo stesso. Se sono zero, nessuno ci è ancora inciampato e la prima strada '
      + 'basta.',
  },
  {
