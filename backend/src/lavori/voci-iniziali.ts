...
export const VOCI_INIZIALI: Voce[] = [
...

  {
    ...
    titolo: '«vino» dentro «bovino»: 212 casi in cui la parola chiave intera combacia dentro un\'altra parola',
    dettaglio:
...

  {
    ...
    titolo: 'Due schede stanno in una colonna prima di una in cui erano già passate — e non è stato il codice',
    dettaglio:
