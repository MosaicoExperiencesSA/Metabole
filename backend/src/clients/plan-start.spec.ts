...
describe('ClientsService.updatePlanStart', () => {
  ...
  beforeEach(() => {
    ...
    service = new ClientsService(prisma, {} as never, audit, {} as never, menu, {} as never, {} as never, {} as never, {} as never, { buildPersonalBase: jest.fn().mockResolvedValue({}) } as never);
  });
