...
function servizio(attuali: { dislikedFoods?: string[]; intolerances?: string[] } = {}) {
  ...
  const s = new ClientsService(prisma, {} as never, { log: jest.fn().mockResolvedValue(undefined) } as never, {} as never, {} as never, {} as never, {} as never, {} as never, {} as never, { buildPersonalBase: jest.fn().mockResolvedValue({}) } as never);
