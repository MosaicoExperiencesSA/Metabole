...
const EMAIL_TEMPLATES = [
  ...
  // Credenziali al lead ("Invia credenziali"): mancava, quindi era l'unica transazionale
  // NON modificabile dal backoffice — il testo veniva solo dai default i18n e chi voleva
