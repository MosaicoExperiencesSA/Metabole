 ...
 *
 * ⚠️ È il GEMELLO di `backoffice/src/lib/scorri-in-fondo.ts`: app e back office sono due progetti
 * separati, senza un pacchetto in comune. Le due si comportano uguale e hanno lo stesso test.
 *
