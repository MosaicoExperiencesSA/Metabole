...
## Aggiornamento 6 agosto 2026 — verificato sul codice

Il piano regge: `commerce/stripe.service.ts:40` usa tuttora **`mode: 'payment'`**, quindi gli
abbonamenti ricorrenti **non esistono ancora**. Attenzione a non farsi ingannare cercando
"recurring" nel codice: le occorrenze che si trovano appartengono al modulo **costi/contabilità**
(`accounting.service.ts`, costi ricorrenti dell'azienda) e non c'entrano nulla con Stripe.

**Perché serve, oltre al Mantenimento**: Simone ha deciso il 6/8 che il **monitoraggio dopo il
mantenimento va venduto in abbonamento** (mentre resta gratuito durante una pausa vacanza). Quindi
questo piano è il prerequisito della voce #10 del feedback clienti del 5/8.

**Ordine deciso**: si affronta **dopo** il resto della lista delle richieste, come progetto a sé.

**La decisione più delicata resta la A3** (provvigioni sul rinnovo): oggi le provvigioni si generano
su ogni pagamento approvato senza distinguere primo acquisto e rinnovo. Senza una regola esplicita,
col ricorrente si pagherebbero provvigioni piene ogni mese, per sempre. Va decisa prima di scrivere
una riga di codice.
