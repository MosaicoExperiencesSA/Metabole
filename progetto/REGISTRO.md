...
- `[Prodotto]` **Pagine legali multilingua (nota IT vincolante)** — **Cookie** e **Termini** tradotti **completi in 9 lingue** con selettore + nota "traduzione di cortesia, versione italiana vincolante". **Privacy**: struttura i18n + selettore + nota, **IT ed EN completi**; le altre 7 lingue (ES/PT/FR/DE/RU/ZH/AR) al momento **ricadono sull'inglese** (con nota IT vincolante) — **da completare** la traduzione piena della Privacy nelle 7 lingue. Tutte con hook `data-i18n-endpoint` (traduzioni dal DB).
