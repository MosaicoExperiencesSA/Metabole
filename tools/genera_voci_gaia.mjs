...
const PHRASES = {
  ...
  diversi: "Prima di iniziare, lascia che ti spieghi in cosa siamo diversi. Con noi hai cinque cose che, messe insieme, non trovi da nessun'altra parte. Uno: una coach vera, una persona che ti sostiene sempre, soprattutto quando è dura. Due: un nutrizionista dedicato, specializzato nella dieta che hai scelto, che verifica il tuo percorso e lo adatta a te. Tre: un motore intelligente, che registra ogni tua indicazione e aggiusta il percorso per farti arrivare all'obiettivo in modo semplice e sostenibile. Quattro: una dieta personalizzata, che tiene conto delle stagioni, dei tuoi gusti e degli eventi che vivrai lungo la strada. E infine io, Gaia, l'assistente Èi Ài che tiene d'occhio tutto e avvisa sempre, in tempo, la persona giusta per aiutarti. Se sei pronta a vivere un'esperienza come nessun'altra prima, e a unirti alle centinaia di persone che lo stanno già facendo, tocca Sono pronta, e cuciremo Metàbol Èi Ài attorno a te.",
