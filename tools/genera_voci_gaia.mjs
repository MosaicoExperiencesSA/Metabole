...
const PHRASES = {
  ...
  diversi_intro: "Prima di iniziare, lascia che ti spieghi in cosa siamo diversi.",
  diversi_1: "Una coach vera: una persona che ti sostiene sempre, soprattutto quando è dura.",
  diversi_2: "Un nutrizionista dedicato, specializzato nella dieta che hai scelto, che verifica il tuo percorso e lo adatta a te.",
  diversi_3: "Un motore intelligente, che registra ogni tua indicazione e adatta il percorso per portarti all'obiettivo in modo semplice e sostenibile.",
  diversi_4: "Una dieta personalizzata, che tiene conto delle stagioni, dei tuoi gusti e degli eventi che vivrai.",
  diversi_5: "E infine io, Gaia, l'assistente Èi Ài che tiene d'occhio tutto e avvisa in tempo la persona giusta per aiutarti.",
  diversi_end: "Se sei pronta a vivere un'esperienza come nessun'altra, tocca sono pronta: cuciremo Metàbol Èi Ài attorno a te.",
