...
export const CATALOG: Shortcut[] = [
  ...
  { id: 'crm_pipeline', pageKey: 'crm_pipeline', to: '/crm/pipeline', icon: 'ti-layout-kanban', label: 'Pipeline', hint: 'Stato dei lead' },
  { id: 'crm_calendario', pageKey: 'crm_calendar', to: '/crm/calendario', icon: 'ti-calendar-event', label: 'Calendario', hint: 'Promemoria' },
  ...
  { id: 'ruoli', pageKey: 'roles', to: '/ruoli', icon: 'ti-shield-half', label: 'Ruoli', hint: 'Ruoli personalizzati' },
