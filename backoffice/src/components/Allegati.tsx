...
/**
 * ⛔ **ALLEGARE UN FILE IN CHAT — un pezzo solo per le due chat del backoffice** (Simone, 16/9:
 * *«nelle chat tutte, anche quella del Nutrizionista»*): la pagina Chat e le conversazioni in
 * scheda cliente. Gemello di `app/src/components/Allegati.tsx`, senza la parte del telefono.
 *
...
/**
 * Gli allegati dentro una bolla: le foto si vedono, gli altri file si aprono in una scheda nuova —
 * la conversazione resta dov'era.
 */
